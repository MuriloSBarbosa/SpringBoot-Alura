...
import murilo.barbosa.estudospring.domain.consulta.Consulta;
import murilo.barbosa.estudospring.domain.endereco.DadosEndereco;
import murilo.barbosa.estudospring.domain.paciente.DadosCadastroPaciente;
...
// Spring faz rollback automaticamente
// Quando iremos mexer testes com persistencia
@DataJpaTest
// Não utilizar bancos em memória, e sim o da aplicação
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
// Leia a application-test
@ActiveProfiles("test")
