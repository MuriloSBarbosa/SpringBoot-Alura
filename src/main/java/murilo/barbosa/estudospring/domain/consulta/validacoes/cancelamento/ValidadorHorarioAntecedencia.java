package murilo.barbosa.estudospring.domain.consulta.validacoes.cancelamento;
...
// Passar nome para não dar conflito com de agendamento pelo spring. O java aceita, mas ele não.
